...
namespace CapaDato
{
    public class DTrabajador
    {
        ...
        //Declarar las Variables por cada campo de la tabla trabajador de la BD
        private int _Idtrabajador;
        private string _Nombre;
        private string _Apellidos;
        private string _Sexo;
        private DateTime _Feha_Nacimiento;
        ...
        public DateTime Feha_Nacimiento
        {
            get
            {
                return _Feha_Nacimiento;
            }

            set
            {
                _Feha_Nacimiento = value;
            }
        }
        ...
        public DTrabajador(int idtrabajador,string nombre,string apellidos,string sexo,
            DateTime fecha_nacimiento,string num_dcumento,string direccion,string telefono,
            string email,string acceso,string usuario, string password,string textobuscar)
        {
            ...
            this.Sexo = sexo;
            this.Feha_Nacimiento = fecha_nacimiento;
            this.Num_Documento = num_dcumento;
        ...
        public string Insertar(DTrabajador Trabajador)
        {
            ...
            try
            {
                ...
                ParFecha_Nacimiento.Value = Trabajador.Feha_Nacimiento;
