...
namespace CapaPresentacion
{
    ...
    {
        //Se declara variable para indicar que se está registrando un nuevo cliente y otra que es para modificar clientes
        ...
        {
            //Descripción de la ubicación  del formulario
            this.Top = 0;
            this.Left = 0;
            this.Mostrar();
            this.Habilitar(false);
        ...
        {
            //Sea igual al items de la colección que se agregó en el combobox
