...
namespace CapaPresentacion
{
    public partial class FrmVenta : Form
    {
            ...
            DateTime fecha_vencimiento)
        {
            ...
            this.txtPrecio_Compra.Text = Convert.ToString(precio_compra); //Esta definido en decimal por eso convertimos en string
        ...
        {
            //Detalles que tendrá mi DataGridView
        ...
        {
            //se detalla como se posicionará el formulario al ejecutar
            this.Top = 0;
            this.Left = 0;
            this.Mostrar();
            this.Habilitar(false);
