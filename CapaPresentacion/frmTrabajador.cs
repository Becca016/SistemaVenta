                ...
                else
                {
                    ...
                    else
                    {
                        rpta = NTrabajador.Editar(Convert.ToInt32(this.txtIdtrabajador.Text),
                            ...
                            this.cbSexo.Text, dtFechaNac.Value, txtNum_Documento.Text, txtDireccion.Text, txtTelefono.Text,
                            txtEmail.Text,cbAcceso.Text,this.txtUsuario.Text,this.txtPassword.Text);
                    }
