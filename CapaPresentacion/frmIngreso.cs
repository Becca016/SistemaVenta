...
namespace CapaPresentacion
{
    ...
    public partial class frmIngreso : Form
    {
        ...
        private DataTable dtDetalle; //almacenar el datatable todos los detalles que tenga el ingreso
        ...
        //Para recibir los valores desde el frmvistaArticulo_ingreso
        ...
        public frmIngreso()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtCorrelativo, "¡Ingrese el número de comprobante!");
        ...
        //Limpiare los botnes referentemente a los detalles del ingreso 
        ...
        {
            this.dataListado.Columns[0].Visible = false;//Es la columna del checkbox
            this.dataListado.Columns[1].Visible = false; //Es la columna de la llave primaria de ingreso
                ...
                else
                {
                    ...
                    foreach (DataRow row in dtDetalle.Rows)
                    {
                        ...
                        if(registrar)
                        {
                            ...
                            //Add detalle al datalistadoDetalle
